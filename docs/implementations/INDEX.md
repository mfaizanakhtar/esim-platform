...
| 0002 | Region schema + CRUD + discovery | in-progress | First-class `Region` entity (EU30, ASIA4, GCC6) with admin CRUD + read-only `/admin/regions/suggestions` that aggregates provider catalogs into INTERSECTION/UNION proposals | [0002-region-schema-crud.md](0002-region-schema-crud.md) |
