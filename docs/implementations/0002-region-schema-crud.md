...
**Shipped:** 2026-04-26 · **PRs:** #226 (schema + CRUD), #227 (discovery), #228 (template generation), #229 (region-aware mapping), #230 (dashboard parity), #231 (discovery filter hotfix), #232 (FiRoam countryCodes normalization), #237 (smarter group labeling)
